...
function drawText() {
    ...
    if(frameNumber > 2000 && frameNumber < 2250){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("and yet here I'm wondering how beautiful it is to get to know you for my Whole life", canvas.width/2, canvas.height/2);
        }
    ...
    if(frameNumber >= 2250 && frameNumber < 2500){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["and yet here I am to get", "chance to get to know you"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much my sweetest potatoe, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
            context.fillText("I love you so much sweetest, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
